...
local background = love.graphics.newImage('costume/background.png')
local backgroundScroll = 0

local ground = love.graphics.newImage('costume/ground.png')
...
function love.load()
    ...
    image = love.graphics.newImage('costume/pause.png')
    ...
    sounds = {
        ...
        ['pause'] = love.audio.newSource('music/pause.wav', 'static'),
...
function love.update(dt)
    if scrolling then
        ...
        function love.draw()
            ...
            gStateMachine:render()
            love.graphics.draw(ground, -groundScroll, VIRTUAL_HEIGHT - 16)
            love.graphics.draw(image, VIRTUAL_WIDTH / 2 - 40 , 100)
